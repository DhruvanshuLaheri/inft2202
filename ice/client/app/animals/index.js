...
function animal(name) {
    ...
    function createContent() {
        ...
        mb3Leg.innerHTML = '<label for="legs" class="form-label">Number of Legs</label>' +
            `<input type="text" class="form-control" id="leg" name="leg" value="${animal!=null?animal.leg:""}">` +
            '<p class="text-danger d-none"></p>';
        ...
        mb3Eye.innerHTML = '<label for="eyes" class="form-label">Number of Eyes</label>' +
           `<input type="text" class="form-control" id="eye" name="eye" value="${animal!=null?animal.eye:""}">` +
            '<p class="text-danger d-none"></p>';
